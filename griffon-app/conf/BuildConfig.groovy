...
griffon {
    doc {
        logo = '<a href="http://griffon-framework.org" target="_blank"><img alt="The Griffon Framework" src="../img/yaba.png" border="0"/></a>'
        sponsorLogo = "<br/>"
...
app.fileType = '.groovy'
app.defaultPackageName = 'sfbrokerapi'
